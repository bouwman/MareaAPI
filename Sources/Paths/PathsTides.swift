...
extension Paths {
    ...
    public struct Tides {
        ...
        public struct GetResponse: Decodable {
            ...
            public init(disclaimer: String? = nil, status: Double, latitude: Double, longitude: Double, origin: Origin, datums: Marea.Datums, timestamp: Double, datetime: String, unit: String, timezone: String, datum: String, extremes: [Extreme], heights: [Height], source: Source, copyright: String) {
            ...
            public init(from decoder: Decoder) throws {
                let values = try decoder.container(keyedBy: StringCodingKey.self)
                self.disclaimer = try values.decodeIfPresent(String.self, forKey: "disclaimer")
        ...
        public struct GetParameters {
            ...
            public init(duration: String? = nil, timestamp: Int? = nil, radius: Double? = nil, interval: Int? = nil, latitude: Double? = nil, longitude: Double? = nil, model: Model? = nil, stationRadius: Int? = nil, stationID: String? = nil, datum: Datum? = nil) {
